...
export default function BodyMapBack({ muscleStyleMap, width = 150, height = 450 }: BodyMapBackProps) {
  const svgData = useSvgBodyMap(require("../../assets/images/svg/calimali-body-back.svg"));
